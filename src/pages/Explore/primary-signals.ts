...
export const primarySignalOptions: Array<SelectableValue<string>> = [
  ...
  },
  {
    ...
    text: 'Explore server-specific segments of traces',
  },
  {
    label: 'Consumer spans',
    value: 'consumer_spans',
    filter: { key: 'kind', operator: '=', value: 'consumer' },
    text: 'Analyze interactions initiated by consumer services',
  },
  {
    label: 'HTTP endpoints',
    value: 'http_endpoints',
    filter: { key: 'span.http.path', operator: '!=', value: '""' },
    text: 'Analyze activities at specific HTTP service points',
  },
  {
